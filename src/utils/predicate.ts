 ...
 * @template T
 */
export function notEmpty<T extends string | Array<E>, E>(value: T | undefined | null): value is T {
 ...
 * @template T
 */
export function isEmpty<T extends string | Array<E>, E>(value: T | undefined | null): value is undefined | null {
